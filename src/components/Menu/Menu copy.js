...
export function Menu({ idIcon = "menu", ...props }) {
  ...
  return (
    <Fragment>
      <nav {...props}>
        <input type="checkbox" name="menu" id="menu" aria-hidden="true" />
        <label htmlFor="menu" aria-hidden="false">
      ...
      <style jsx>{`
        ...
        @media screen and (max-width: 1023px) {
          // Not support hover, clickable menu
          @media not (any-hover: hover) {
            // Drop list open/close behavior
            ...
            // Show X to close expanded sub menu
