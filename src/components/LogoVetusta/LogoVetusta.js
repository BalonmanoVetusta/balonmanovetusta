...
export function LogoVetusta({
  ...
  descriptionId = "club-balonmano-vetustaDescriptionId",
  ...
  try {
    ...
    darkFill = LOGO_YELLOW;
    lightFill = LOGO_BLACK;

    darkShadow = `${LOGO_YELLOW}50`;
    lightShadow = `${LOGO_BLACK}50`;
  }
      ...
      <style global jsx>{`
        @media only screen and (prefers-color-scheme: dark) {
          :root:not([data-theme="light"]) {
            ${cssVariableName}: ${darkFill};
            ${cssVariableName}-shadow: ${darkShadow};
          }
        }
        [data-theme="dark"] {
          ${cssVariableName}: ${darkFill};
        ...
        @media only screen and (prefers-color-scheme: light) {
          :root:not([data-theme="dark"]) {
            ${cssVariableName}: ${lightFill};
            ${cssVariableName}-shadow: ${lightShadow};
          }
        }
        [data-theme="light"] {
          ${cssVariableName}: ${lightFill};
